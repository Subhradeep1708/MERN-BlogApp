  ...
  return (
    <div className='grid md:grid-cols-2 mt-8 gap-8'>
      ...
      <div className="w-full">
        {/* image */}
        <Image src='/featured1.jpeg' className='rounded-3xl object-cover w-full ' w='895' />
        {/* detail */}
        ...
        <div className="lg:h-1/3 flex justify-between gap-4 ">
          <div className="w-1/3 aspect-video">
            <Image
              ...
              w='298'
            />
          </div>          {/* details and title */}
          <div className="w-2/3">
            {/* details */}
            <div className="flex items-center gap-4 text-sm lg:text-base">
              <h1 className='font-semibold'>03.</h1>
              <Link className='text-blue-800'>Architecture </Link>
        ...
        <div className="lg:h-1/3 flex justify-between gap-4 ">
          ...
          <div className="w-2/3">
            ...
            <div className="flex items-center gap-4 text-sm lg:text-base">
              ...
              <Link className='text-blue-800'>Arts</Link>
